...
[ "x$RBDOMAINIP" != "x" ] && echo "$RBDOMAINIP data.$CLOUDDOMAIN $CLOUDDOMAIN s3.service.$CLOUDDOMAIN erchef.service erchef.$CLOUDDOMAIN erchef.service.$CLOUDDOMAIN http2k.service http2k.$CLOUDDOMAIN webui.service.$CLOUDDOMAIN" >> /etc/hosts
